...
## Get M3u8 (Direct Stream)
Get m3u8 stream URL directly with a single request.

**Endpoint** - `/api/v1/getM3u8?id=tt1877830&lang=English`
...
```bash
{
    "success": true,
    "data": {
        "link": "https://example.com/stream/index.m3u8",
        "language": "English",
        "availableLanguages": ["Hindi", "English", "Tamil", "Telugu", "Bengali"]
    }
}
```
...
|--|--|--|--|
|id|IMDB ID of movie/series|True|-
|lang|Language of the stream|False|English

**Try** - [try](https://8-stream-api.vercel.app/api/v1/getM3u8?id=tt1877830)
